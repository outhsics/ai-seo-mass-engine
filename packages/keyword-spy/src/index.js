 ...
 * 自动爬取并分析 SEO 关键词
 */
import { KeywordScraper } from './scraper.js';
import { KeywordAnalyzer } from './analyzer.js';
...
export class KeywordScraper {
    ...
    async scrapeGoogleSuggestions(query) {
